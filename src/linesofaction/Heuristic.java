  ...
  public static int piecePosition(int[][] board, int turn){
      ...
      int[][] valueTable =
              {{-80,-50,-50,-50,-50,-50,-50,-80},
                      ...
                      {-50,20,125,125,125,125,20,-50},
                      {-50,20,125,500,500,125,20,-50},
                      {-50,20,125,500,500,125,20,-50},
                      {-50,20,125,125,125,125,20,-50},
                      {-50,20,20,20,20,20,20,-50},
                      {-80,-50,-50,-50,-50,-50,-50,-80}};
    ...
    for (int i = 0; i < 8; i++){
      for(int j= 0; j < 8; j++){
        ...
        if (board[i][j] > 0 && board[i][j] < 13) {
          ...
          checkSurroundings(i, j, false, board, visitedWhites, visitedBlacks);
          ...
          checkSurroundings(i, j, true, board, visitedWhites, visitedBlacks);
